# 1. 电商移动前端API文档
## 1.1. 路径说明
- 基准路径为 http://157.122.54.189:9094/api/public/v1/
- 访问路径分为两种（其中私有路径必须登录后才可以访问）
    + 公开路径http://157.122.54.189:9094/api/public/v1/
    + 私有路径 http://157.122.54.189:9094/api/public/v1/my
...
### 1.2.1. 主页API
#### 1.2.1.1. 获取首页轮播图数据
- 请求路径：http://157.122.54.189:9094/api/public/v1/home/swiperdata
- 请求方法：get
- 响应参数
...
#### 1.2.1.2. 获取首页分类菜单数据
- 请求路径：http://157.122.54.189:9094/api/public/v1/home/catitems
- 请求方法：get
- 响应参数
...
#### 1.2.1.3. 获取首页商品列表数据
- 请求路径：http://157.122.54.189:9094/api/public/v1/home/goodslist
- 请求方法：get
- 响应参数
...
### 1.2.2. 商品API
#### 1.2.2.1. 搜索建议查询
- 请求路径：http://157.122.54.189:9094/api/public/v1/goods/qsearch
- 请求方法：get
...
#### 1.2.2.2. 商品列表搜索
- 请求路径：http://157.122.54.189:9094/api/public/v1/goods/search
- 请求方法：get
...
#### 1.2.2.3. 商品详情
- 请求路径：http://157.122.54.189:9094/api/public/v1/goods/detail
- 请求方法：get
...
### 1.2.3. 分类API
#### 1.2.3.1. 获取分类数据
- 请求路径：http://157.122.54.189:9094/api/public/v1/categories
- 请求方法：get
- 响应参数
...
### 1.2.4. 用户API
#### 1.2.4.1. 获取验证码
- 请求路径：http://157.122.54.189:9094/api/public/v1/users/get_reg_code
- 请求方法：post
...
#### 1.2.4.2. 注册
- 请求路径：http://157.122.54.189:9094/api/public/v1/users/reg
- 请求方法：post
...
#### 1.2.4.3. 登录
- 请求路径：http://157.122.54.189:9094/api/public/v1/login
- 请求方法：post
...
### 1.3.1. 用户API
#### 1.3.1.1. 获取用户信息
- 请求路径：http://157.122.54.189:9094/api/public/v1/my/users/userinfo
- 请求方法：get
- 响应参数
...
### 1.3.2. 购物车API（登录后访问）
#### 1.3.2.1. 查询购物车数据
- 请求路径：http://157.122.54.189:9094/api/public/v1/my/cart/all
- 请求方法：get
- 响应参数

#### 1.3.2.2. 购物车添加商品
- 请求路径：http://157.122.54.189:9094/api/public/v1/my/cart/add
- 请求方法：post
- 请求参数
...
#### 1.3.2.3. 同步购物车
- 请求路径：http://157.122.54.189:9094/api/public/v1/my/cart/sync
- 请求方法：post
- 请求参数
...
### 1.3.3. 订单API
#### 1.3.3.1. 创建订单
- 请求路径：http://157.122.54.189:9094/api/public/v1/my/orders/create
- 请求方法：post
...
#### 1.3.3.2. 订单查询
- 请求路径：http://157.122.54.189:9094/api/public/v1/my/orders/all
- 请求方法：get
